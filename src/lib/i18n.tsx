...
const copy: Record<AppLang, Record<string, string>> = {
  en: {
    ...
    prv_readyPublish: "Ready to Publish",
    prv_scanLink: "Scan Link",
    prv_copyTitle: "Copy menu URL",
    prv_checklist: "Onboarding Checklist",
    prv_categories: "{n} Categories",
    prv_menuItems: "{n} Menu Items",
    prv_edit: "Edit",
    prv_simTitle: "Interactive Mobile Simulator",
    prv_sim1: "Try the search bar and filter categories with the pill tags",
    prv_sim2: "Your brand accent colors every call-to-action",
    prv_sim3: "Prices format as Tunisian Dinars (DT) automatically",
    prv_backToProducts: "Back to Products",
    prv_goDashboard: "Go to Dashboard",
    ...
    prv_whatNextTitle: "What happens next?",
    prv_whatNextDesc: "From the Owner Dashboard you can generate a unique QR code for every table, print them, invite workers, and watch orders arrive in real time. Your menu is synced to the cloud as you edit — scan the menu link above on any phone.",
    prv_unnamed: "Unnamed",
  ...
  fr: {
    ...
    prv_readyPublish: "Prêt à publier",
    prv_scanLink: "Lien de scan",
    prv_copyTitle: "Copier l'URL du menu",
    prv_checklist: "Checklist d'installation",
    prv_categories: "{n} catégories",
    prv_menuItems: "{n} articles au menu",
    prv_edit: "Modifier",
    prv_simTitle: "Simulateur mobile interactif",
    prv_sim1: "Essayez la barre de recherche et filtrez les catégories avec les pastilles",
    prv_sim2: "Votre couleur d'accent teinte chaque appel à l'action",
    prv_sim3: "Les prix s'affichent automatiquement en dinars tunisiens (DT)",
    prv_backToProducts: "Retour aux produits",
    prv_goDashboard: "Aller au tableau de bord",
    ...
    prv_whatNextTitle: "Et ensuite ?",
    prv_whatNextDesc: "Depuis le tableau de bord propriétaire, générez un QR code unique par table, imprimez-les, invitez des employés et regardez les commandes arriver en temps réel. Votre menu est synchronisé dans le cloud pendant vos modifications — scannez le lien ci-dessus sur un téléphone.",
  ...
  ar: {
    ...
    prv_readyPublish: "جاهز للنشر",
    prv_scanLink: "رابط المسح",
    prv_copyTitle: "نسخ رابط المنيو",
    prv_checklist: "قائمة التحقق",
    prv_categories: "{n} أصناف",
    prv_menuItems: "{n} عناصر في المنيو",
    prv_edit: "تعديل",
    prv_simTitle: "محاكي الجوال التفاعلي",
    prv_sim1: "جرّب شريط البحث وفلتر الأصناف بالشرائح",
    prv_sim2: "لون علامتك يلوّن كل أزرار الإجراء",
    prv_sim3: "تُعرض الأسعار تلقائيًا بالدينار التونسي (DT)",
    prv_backToProducts: "العودة إلى المنتجات",
    prv_goDashboard: "الذهاب إلى لوحة التحكم",
    ...
    prv_whatNextTitle: "ماذا بعد؟",
    prv_whatNextDesc: "من لوحة تحكم المالك يمكنك توليد رمز QR فريد لكل طاولة وطباعتها ودعوة الموظفين ومشاهدة الطلبات لحظة وصولها. منيّوك متزامن مع السحابة أثناء التعديل — امسح الرابط أعلاه بأي هاتف.",
